...
<pre>
encomenda = Correios.encomenda("seu_codigo_de_encomenda")
...
infos = dhlgm.track('GM555113775306714774')
...
<pre>
from royal.royal import Royal

royal = Royal()

infos = royal.track('FI107380836GB')
