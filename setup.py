...
setup(
    ...
    long_description = 'API Python para obter informacoes de encomendas/Sedex dos Correios. Para mais detalhes veja a documentação no Github: http://github.com/guilhermechapiewski/correios-api-py/blob/master/README.textile',
